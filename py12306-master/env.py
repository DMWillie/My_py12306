...
NOTIFICATION_API_APP_CODE = '94e09ceab97f40f3834e555fd09ecde5'
NOTIFICATION_VOICE_CODE_PHONE = '13422343689'  # 接受通知的手机号
...
QUERY_JOBS = [
    ...
    # {
    # #     'job_name':  'aks -> wlmq',  # 任务名称，不填默认会以车站名命名，不可重复
    #     'account_key': 0,  # 将会使用指定账号下单
    #     'left_dates': [
    #         "2020-01-18",
    #         #"2019-01-19"
